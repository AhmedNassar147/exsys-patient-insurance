/*
 *
 * Package: `@exsys-patient-insurance/details-icon`.
 *
 */
...
const DetailsIcon = (props: BaseStyledSvgProps) => (
  <BaseStyledSvg {...props} viewBox="0 0 25 20">
    <g>
      <path
        d="M25,2.6C25,1,24,0,22.4,0C18.2,0,10,0,5.8,0C4.2,0,3.2,1,3.2,2.6c0,1.3,0,2.6,0,3.8c0,0.3-0.2,0.7-0.4,0.9
